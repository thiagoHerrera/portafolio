...
<body>
    ...
    <div class="card-container">
        ...
        while ($producto = $query->fetch(PDO::FETCH_ASSOC)) { // cumple la funcion de mostrar las hamburguesas con sus imagenes, descripcion, etc 
    ...
    <div id="cart-sidebar" class="cart-sidebar">
        ...
        <?php
            $total = 0; 
             ...
             if (!empty($_SESSION['carrito'])) { // el empty sirve para determinar si la variable existe o si su valor es false
